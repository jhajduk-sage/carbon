Feature: Design Systems Menu component
  ...
  @positive
  Scenario Outline: Check that the Search component is focusable by using the "<key>" key
    Given I open "Design System Menu" component page "submenu with search" in no iframe
      ...
      And I wait 50
    When I press keyboard "<key>" key times 1
  ...
  @positive
  Scenario Outline: Check that the Search component close icon is focusable in Menu when using keyboard navigation
    Given I open "Design System Menu" component page "submenu with search" in no iframe
      And I click onto root in Test directory in no iFrame
      And I hit Tab key 1 time in no Iframe
      And I wait 50
      ...
      And I wait 50
      And I press keyboard "FooBar" key times 1
